...
<?php $this->section('js') ?>
	...
	var navbar	='<button class="nav-link active" id="firsttab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-selected="true">\
	...
	var tabcontent = '<div class="card-tools">\
	...
	var data		= '<div class="card">\
						...
						<div class="card-body tab-content" id="myTabContent">\
								<div class="tab-pane fade show active" id="firsttab_content" role="tabpanel" aria-labelledby="nav-home-tab">\
								'+tabcontent+'\
								</div>\
							</div>\
						</div>';

		$( '<button class="nav-link" data-bs-toggle="tab" id="next_tab" data-bs-target="#nav-profile" type="button" role="tab" aria-selected="false"><input type="hidden" name="barn['+barnIndex+'][id]" value="'+barnId+'">\
				<input type="text" id="barn'+barnIndex+'name" name="barn['+barnIndex+'][name]" class="form-control" placeholder="Enter Barn Name" value="'+barnName+'"></button>').insertAfter( "#firsttab" );

		$( '<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">next tab content</div>').insertAfter( "#firsttab_content" );
		...
		{  
			...
			$(document).find('.barn_wrapper_'+barnIndex).append(dataa); 
		...
		$('#firsttab').append($('<li><a href="#tab' + tabID + '" role="tab" data-toggle="tab"><span>Tab ' + tabID + '</span> <span class="glyphicon glyphicon-pencil text-muted edit"></span> <button class="close" type="button" title="Remove this page">×</button></a></li>'));
