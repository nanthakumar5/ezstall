						...
						<div class="navbar-collapse collapse" id="responsive-navbar-nav">
							...
							<?php if($userdetail){ ?>
								<div class="navbar-nav">
									<a href="<?php echo base_url().'/myaccount/events'; ?>" class="ml-2rem nav-link">Hi <?php echo ucfirst($userdetail['name']);?></a>/
				...
				<nav id="sidebar-nav">
					<ul class="list-unstyled components">
						<li class="side-nav-active">
						  <a href="#homeSubmenu" class="side-nav-a" data-toggle="collapse" aria-expanded="false">
						...
						<a class="side-nav-a" href="#">
							<i class="side-nav-i bi bi-house"></i>
							Add Barn
						</a>
						<a class="side-nav-a" href="#">
							<i class="side-nav-i bi bi-shop-window"></i>
							Add Stalls
						</a>
						<a class="side-nav-a" href="#">
							<i class="side-nav-i bi bi-person"></i>
